 ...
 */
public class MealsView extends View {
	...
	public MealsView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public MealsView(Context context, AttributeSet attrs, int defStyle) {
