 ...
 */
public class FlikFoodView extends View {
	...
	public FlikFoodView(Context context) {
		super(context);
		init(null, 0);
	}

	public FlikFoodView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public FlikFoodView(Context context, AttributeSet attrs, int defStyle) {
