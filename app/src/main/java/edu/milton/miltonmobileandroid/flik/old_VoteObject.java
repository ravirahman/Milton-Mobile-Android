...
public class old_VoteObject {
    ...
    public old_VoteObject(int numericalID, int mealID, String email, int vote, String date){
    ...
    public old_VoteObject(int mealID, String email, int vote, String date){
        numericalID = 0;
        this.mealID = mealID;
        this.email = email;
        this.vote = vote;
    ...
    public old_VoteObject(JSONObject jobj) {
